...
def _check_date(date: str):
    ...
    # проверка на соответствие кол-ва символов формату
    if len(day) != len(month) != 2 or len(year) != 4:
...
if __name__ == '__main__':
    print("Дата - корректная" if check_date(input("Введите дату в формате DD.MM.YYYY: ")) else "Некорректная дата")
